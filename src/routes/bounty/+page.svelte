...
>
    ...
    {#if form?.success}
        <p class="pt-2 font-bold font-mono">
            Bounty deployed successfully! <a href={form?.tx}>Transaction link</a
            >
        </p>
    {/if}
</div>
...
>
    ...
    {#if form?.success}
        <p class="pt-2 font-bold font-mono">
            Bounty unlocked successfully! <a href={form?.tx}>Transaction link</a
            >
        </p>
    {/if}
</div>
