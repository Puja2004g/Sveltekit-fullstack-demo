...
>
    ...
    {#if form?.deployed}
        ...
        <p class="pt-2 text-green-600 font-bold font-mono">
...
<div
    class="mt-10 pt-10 mb-20 w-full max-w-xl p-5 mx-auto rounded-lg shadow-xl dark:bg-white/10 bg-white/30 ring-1 ring-gray-900/5 backdrop-blur-lg"
>
