...
export const actions = {
    login: async ({ request }) => {
        ...
        // const payResponse = await neucron.pay
        //     .txSpend(options)
        ...
        return { success_login: true, balance: DefaultWalletBalance.data.balance.summary };
    },
    ...
    pay: async ({ request }) => {
        ...
        return { success_pay: true, payment: payResponse };
